"""
Django settings for tweesta project.
...
SECRET_KEY = 'django-insecure-qn&gjjt_4%1steav#rae=8k1ss*-#eov@+e^-v(_pba4@@2_73'
...
ROOT_URLCONF = 'tweesta.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [],
        'DIRS': [os.path.join(BASE_DIR, "templates"), os.path.join(BASE_DIR, "tweety/templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'tweesta.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        # For PostgreSQL, MySQL, etc., add USER, PASSWORD, HOST, and PORT
    }
}
